...
# ----------------------------------------------------------------------------------------------------------------------
#
#      Class handling section of DFAUST dataset.
#      Implements a Dataset, a Sampler, and a collate_fn
#
# ----------------------------------------------------------------------------------------------------------------------
#
#      Hugues THOMAS - 11/06/2018
# edited luigia than 12/2023
...
class JJDataset(PointCloudDataset):
    ...
    def __init__(self, config, set='training', use_potentials=True, load_data=True):
        ...
        """
        PointCloudDataset.__init__(self, 'JJ')
...
class JJSampler(Sampler):
    """Sampler for S3DIS"""

    def __init__(self, dataset: JJDataset):
    ...
    def calibration(self, dataloader, untouched_ratio=0.9, verbose=False, force_redo=False):
        ...
        if exists(batch_lim_file):
            with open(batch_lim_file, 'rb') as file:
                ...
                print("print for pickle 1103")
        else:
            batch_lim_dict = {}
            print("batch lim empyth")
...
def JJCollate(batch_data):
    return JJCustomBatch(batch_data)
